...
describe User do
  ...
  it "devrait accepter une adresse email valide" do
  	...
  	adresses.each do |address|
  		valide_email_user = User.new(@attr.merge(:email => address))
  		valide_email_user.should be_valid
  	end
  end
  ...
  it "devrait rejeter un email deja present en base" do
  	User.create!(@attr)
  	user_with_duplicate_email = User.new(@attr)
  	user_with_duplicate_email.should_not be_valid
  end

  it "devrait rejeter un email invalide jusqu'a la casse" do
  ...
  describe "password validations" do
  	...
  	it "devrait exiger une confirmation du mot de passe qui correpond" do
